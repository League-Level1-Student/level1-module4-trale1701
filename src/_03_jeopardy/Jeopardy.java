...
public class Jeopardy implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		// If the buttonPressed was the secondButton
			...
			askQuestion("What's 2 + 2?", "4", 200);
			secondButton.setText(null);
		}
		
		else if (e.getSource().equals(thirdButton)) {

			// Call the askQuestion() method with a harder question
			askQuestion("What's 3 + 3?", "6", 300);
			thirdButton.setText(null);
		}
		
		else if (e.getSource().equals(fourthButton)) {

			// Call the askQuestion() method with a harder question
			askQuestion("What's 4 + 4", "8", 400);
			fourthButton.setText(null);
		}
		
		else if (e.getSource().equals(fifthButton)) {

			// Call the askQuestion() method with a harder question
			askQuestion("What's 5 + 5", "10", 500);
			fifthButton.setText(null);
		}
		
		else if (e.getSource().equals(sixthButton)) {

			// Call the askQuestion() method with a harder question
			askQuestion("What's 6 + 6", "12", 600);
